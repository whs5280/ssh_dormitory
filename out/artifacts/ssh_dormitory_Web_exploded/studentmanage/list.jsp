  ...
  <head>
	...
	<script type="text/javascript">
		...
		$(function(){
            ...
            $("#dg").datagrid('hideColumn', 'student_remark');
    ...
    <div id="dlg" class="easyui-dialog" style="width:420px;height:425px;padding:10px 20px"
        ...
        <form id="fm" method="post">
        	<table cellspacing="10px;">
        		...
        		<tr>
        			<td>学院：</td>
        			<td><%--<input name="vo.student_institution" id="student_institution" class="easyui-validatebox" required="true" style="width: 200px;">--%>
						<select name="vo.student_institution" id="student_institution" class="easyui-validatebox" required="true" style="width: 200px;">
							<option value="政治与法学学院">政治与法学学院</option>
							<option value="新闻传播学院">新闻传播学院</option>
							<option value="音乐学院">音乐学院</option>
							<option value="美术学院">美术学院</option>
