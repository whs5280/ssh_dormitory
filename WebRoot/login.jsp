			...
			<div class="con_panel">
				<form id="form" method="post" action="systemManageAction!denglu.action">
					...
					<div class="con_select">
						<input type="radio" name="flag" id="flag1" value="student" checked="checked"/>学生
						<input type="radio" name="flag" id="flag2" value="teacher" />楼宇管理员
						<input type="radio" name="flag" id="flag3" value="system" />系统管理员
					</div>
