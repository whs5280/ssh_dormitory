    ...
    $(function(){
		...
		var treeStuDate=[{
          ...
          var treeCheckDate=[{
              text:"考勤记录",
              attributes:{
                  url:"checkmanager/checklist.jsp"
              }
          }
          ];
        ...
        var treeVisitorDate=[{
            text:"来访记录",
            attributes:{
                url:"visitormanage/visitorlist.jsp"
            }
        }
        ];
        ...
        $("#checktreeTeacher").tree({
            data:treeCheckDateTeacher,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
        ...
        $("#visitortreeTeacher").tree({
            data:treeVisitorDateTeacher,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
        ...
        $("#costtreeTeacher").tree({
            data:treeCostDateTeacher,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
        ...
        $("#costtreeStudent").tree({
            data:treeCostDateStudent,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
        ...
        $("#costtreeVipStudent").tree({
            data:treeCostDateVipStudent,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
        ...
        $("#fixtreeVipStudent").tree({
            data:treeFixDateVipStudent,
            lines:false,
            onClick:function(node){
                if(node.attributes){
                    openTab(node.text,node.attributes.url);
 ...
 <body class="easyui-layout">  
    ...
    <div region="west" split="false" title="<center>导航菜单</center>" style="width: 200px">  
		...
		<div id="showSystem" class="easyui-accordion"  fit="true">   
		    <div title='学生管理' class="menuDiv"  style="overflow:auto;">
		    	<ul class="easyui-tree" id="studenttree"></ul>  
		    </div>   
		    <div title='楼宇管理' class="menuDiv">
		        <ul class="easyui-tree" id="buildtree"></ul>    
		    </div>
		    <div title='楼宇管理员管理' class="menuDiv">
		        <ul class="easyui-tree" id="teachertree"></ul>    
		    </div> 
		    <div title='宿舍管理'  class="menuDiv">
		        <ul class="easyui-tree" id="dormtree"></ul>    
		    </div>
			<div title='考勤管理'  class="menuDiv">
				<ul class="easyui-tree" id="checktree"></ul>
			</div>
			<div title='来访管理'  class="menuDiv">
				<ul class="easyui-tree" id="visitortree"></ul>
			</div>
			<div title='费用管理'  class="menuDiv">
				<ul class="easyui-tree" id="costtree"></ul>
			</div>
			<div title='维修管理'  class="menuDiv">
				<ul class="easyui-tree" id="fixtree"></ul>
			</div>
		    <div title='日志查看' class="menuDiv">
		...
		<div id="showTeacher" class="easyui-accordion"  fit="true">   
			...
			<div title='考勤管理'  class="menuDiv">
				<ul class="easyui-tree" id="checktreeTeacher"></ul>
			</div>
			<div title='来访管理'  class="menuDiv">
				<ul class="easyui-tree" id="visitortreeTeacher"></ul>
			</div>
			<div title='费用管理'  class="menuDiv">
				<ul class="easyui-tree" id="costtreeTeacher"></ul>
			</div>
			<div title='维修管理'  class="menuDiv">
				<ul class="easyui-tree" id="fixtreeTeacher"></ul>
			</div>
		    <div title='消息处理'  class="menuDiv">
		...
		<div id="showStudent" class="easyui-accordion"  fit="true">   
		    ...
		    <div title='申请登记' class="menuDiv">
		        <ul class="easyui-tree" id="applytreeStudent"></ul>    
		    </div>
			<div title='费用管理'  class="menuDiv">
				<ul class="easyui-tree" id="costtreeStudent"></ul>
			</div>
			<div title='维修管理'  class="menuDiv">
				<ul class="easyui-tree" id="fixtreeStudent"></ul>
			</div>
		</div>  
		...
		<div id="showVipStudent" class="easyui-accordion"  fit="true">   
			...
			<div title='费用管理'  class="menuDiv">
				<ul class="easyui-tree" id="costtreeVipStudent"></ul>
			</div>
			<div title='维修管理'  class="menuDiv">
				<ul class="easyui-tree" id="fixtreeVipStudent"></ul>
			</div>
		</div> 
    </div>  
